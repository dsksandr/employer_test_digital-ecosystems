...
gulp.task('font:watch', () => {
    return gulp.watch('app/font/**/*', gulp.series('font', (done) => {
        browsersync.reload();
        done();
    }));
});
...
gulp.task('img:watch', () => {
    return gulp.watch('app/img/**/*.+(png|jpg|svg|mp4)', gulp.series('img', (done) => {
        browsersync.reload();
        done();
    }));
});
gulp.task('default', gulp.series('clean', gulp.parallel('img:watch', 'html', 'sass', 'json', 'js:es6', 'font', 'font:watch', 'js:es5', 'img', 'server', 'sass:watch', 'html:watch', 'js:watch', 'json:watch')));
